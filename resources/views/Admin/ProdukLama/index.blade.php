...
@include('Admin.ProdukLama.tambah', ['kategori' => $kategori])
@include('Admin.ProdukLama.edit', ['kategori' => $kategori])
@include('Admin.ProdukLama.hapus')
@include('Admin.ProdukLama.gambar')
...
<script>
    ...
    $(document).ready(function() {
        table = $('#table-1').DataTable({
            ...
            lengthChange: true,
            "ajax": {
                "url": "{{route('produklama.getproduklama')}}",
            },
            "columns": [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
