    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Ubah Produk Masuk</h6><button aria-label="Close" onclick="resetU()"
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bmkodeU" class="form-label">Kode Produk Masuk <span
                        ...
                        <div class="form-group">
                            <label for="keteranganU" class="form-label">Keterangan <span
                                    class="text-danger">*</span></label>
                            <textarea name="keteranganU" id="keteranganU" class="form-control" rows="3" placeholder="Masukkan keterangan"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
@section('formEditJS')
    <script>
        ...
        function submitFormU() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ url('admin/masuk/proses_ubah') }}/" + id,
