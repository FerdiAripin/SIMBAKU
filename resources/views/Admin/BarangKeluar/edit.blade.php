    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Ubah Produk Keluar</h6><button aria-label="Close" onclick="resetU()" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="bkkodeU" class="form-label">Kode Produk Keluar <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="keteranganU" class="form-label">Keterangan <span class="text-danger">*</span></label>
...
<script>
    ...
    function submitFormU() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('admin/keluar/proses_ubah') }}/" + id,
    ...
    function resetValidU() {
        ...
        $("input[name='keteranganU']").removeClass('is-invalid');
