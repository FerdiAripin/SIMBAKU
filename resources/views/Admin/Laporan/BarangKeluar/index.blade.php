...
@section('content')
    <div class="page-header">
        <h1 class="page-title">Laporan Produk Keluar</h1>
        <div>
            <ol class="breadcrumb">
...
@section('scripts')
    <script>
        ...
        function print() {
            ...
            var url = "{{ route('lap-bk.print') }}?jenis=" + jenis;
        ...
        function pdf() {
            ...
            console.log('=== PDF Barang Keluar Function Called ===');
            ...
            if (!jenis || (jenis !== 'baru' && jenis !== 'lama')) {
                console.error('Invalid jenis value:', jenis);
                validasi('Pilih jenis produk terlebih dahulu!', 'error');
                return;
            }

            var url = "{{ route('lap-bk.pdf') }}?jenis=" + encodeURIComponent(jenis);
            ...
            if ((tglawal != '' && tglakhir != '') || kategori != '') {
                ...
                swal({
                    ...
                    text: "Ini akan mengexport semua data barang keluar " + (jenis === 'baru' ? 'produk baru' :
                        'produk lama'),
                    type: "warning",
                    buttons: true,
                    dangerMode: true,
        ...
        function downloadPdf(url) {
            ...
            fetch(url, {
                ...
                .catch(error => {
                    ...
                    swal({
                        title: "Error!",
                        text: "Gagal generate PDF: " + error.message,
                        type: "error",
